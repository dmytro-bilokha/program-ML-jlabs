...
public class NeuralNetworkBatchedStandardized {
    ...
    public static void main(String[] cliArgs) {
        ...
        var reporter = new Reporter(xTrain, yTrain, xValidation, yValidation, reportingQueue);
        reporter.start();
        train(xTrain, yTrain, reportingQueue, 100, 10, 256, 1d);
    ...
    private static MatrixPair calculateForward(DoubleMatrix x, DoubleMatrix w1, DoubleMatrix w2) {
        var h = x.prependColumn(1d).multiply(w1).apply(NeuralNetworkBatchedStandardized::calculateSigmoid);
